...
public class SqlLogLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "ESCAPE", "DATE", 
			"YEAR", "MONTH", "DATEVALUE", "NUMBER", "ERRORCODERANGE", "STRING", "TIME", 
			"HOURS", "MINUTES", "SECONDS", "MILLISECONDS", "ZEROTOSIXTY"
		};
	}
	...
	public SqlLogLexer(CharStream input) {
		super(input);
